...
const CartWidget = () => {
    ...
    return (
        ...
        <div>
            <div data-bs-toggle="modal" data-bs-target="#exampleModal"><span style={{color:'white'}}>Cart <i style={{color:'white', with:'15px'}} className="fas fa-shopping-cart fa-1x pe-5"> 0</i></span>
            </div>
